...
namespace ISOCertificate.Migrations
{
    ...
    [Migration("20200906125937_nominateLine")]
    partial class nominateLine
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISOCertificate.Models.EvaluationLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISOCertificate.Models.EventLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISOCertificate.Models.Investigate", b =>
                {
                    ...
                    b.Property<string>("BriefDecription")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("IdentifyDescription")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("NominateLineTypeId")
                        .HasColumnType("int");

                    b.Property<int?>("NominatedLineType")
                        .HasColumnType("int");

                    b.Property<int?>("OccurenceCauseId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("OutcomeBuisnessId")
                        .HasColumnType("int");

                    b.Property<int?>("OutcomeEnviromentId")
                        .HasColumnType("int");

                    b.Property<int?>("OutcomePeopleId")
                        .HasColumnType("int");

                    b.Property<int?>("OutcomePropertyId")
                        .HasColumnType("int");

                    b.Property<string>("Position")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("PossibleBuisnessId")
                        .HasColumnType("int");

                    b.Property<int?>("PossibleEnviromentId")
                        .HasColumnType("int");

                    b.Property<int?>("PossiblePeopleId")
                        .HasColumnType("int");

                    b.Property<int?>("PossiblePropertyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NominateLineTypeId");

                    b.HasIndex("OccurenceCauseId");

                    b.HasIndex("OccurenceReasonId");

                    b.HasIndex("OccurenceTypeId");

                    b.HasIndex("OutcomeBuisnessId");

                    b.HasIndex("OutcomeEnviromentId");

                    b.HasIndex("OutcomePeopleId");

                    b.HasIndex("OutcomePropertyId");

                    b.HasIndex("PossibleBuisnessId");

                    b.HasIndex("PossibleEnviromentId");

                    b.HasIndex("PossiblePeopleId");

                    b.HasIndex("PossiblePropertyId");
            ...
            modelBuilder.Entity("ISOCertificate.Models.LessonLearned", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISOCertificate.Models.NominateLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NominateLine");
                });

            modelBuilder.Entity("ISOCertificate.Models.NominateLineType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NominateLineType");
                });

            modelBuilder.Entity("ISOCertificate.Models.OccurenceCause", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISOCertificate.Models.OutcomeBuisness", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OutcomeBuisness");
                });

            modelBuilder.Entity("ISOCertificate.Models.OutcomeEnviroment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OutcomeEnviroment");
                });

            modelBuilder.Entity("ISOCertificate.Models.OutcomePeople", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OutcomePeople");
                });

            modelBuilder.Entity("ISOCertificate.Models.OutcomeProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OutcomeProperty");
                });

            modelBuilder.Entity("ISOCertificate.Models.PossibleBuisness", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PossibleBuisness");
                });

            modelBuilder.Entity("ISOCertificate.Models.PossibleEnviroment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PossibleEnviroment");
                });

            modelBuilder.Entity("ISOCertificate.Models.PossiblePeople", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PossiblePeople");
                });

            modelBuilder.Entity("ISOCertificate.Models.PossibleProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PossibleProperty");
                });

            modelBuilder.Entity("ISOCertificate.Models.PreventLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ISOCertificate.Models.Investigate", b =>
                {
                    ...
                    b.HasOne("ISOCertificate.Models.LessonLearned", "LessonLearned")
                        .WithMany("Investigates")
                        .HasForeignKey("LessonLearnedId");

                    b.HasOne("ISOCertificate.Models.NominateLineType", "NominateLineType")
                        .WithMany()
                        .HasForeignKey("NominateLineTypeId");

                    b.HasOne("ISOCertificate.Models.OccurenceCause", "OccurenceCause")
                        .WithMany("Investigates")
                        .HasForeignKey("OccurenceCauseId");
                    ...
                    b.HasOne("ISOCertificate.Models.OutcomeBuisness", "OutcomeBuisness")
                        .WithMany("Investigates")
                        .HasForeignKey("OutcomeBuisnessId");

                    b.HasOne("ISOCertificate.Models.OutcomeEnviroment", "OutcomeEnviroment")
                        .WithMany("Investigates")
                        .HasForeignKey("OutcomeEnviromentId");

                    b.HasOne("ISOCertificate.Models.OutcomePeople", "OutcomePeople")
                        .WithMany("Investigates")
                        .HasForeignKey("OutcomePeopleId");

                    b.HasOne("ISOCertificate.Models.OutcomeProperty", "OutcomeProperty")
                        .WithMany("Investigates")
                        .HasForeignKey("OutcomePropertyId");

                    b.HasOne("ISOCertificate.Models.PossibleBuisness", "PossibleBuisness")
                        .WithMany("Investigates")
                        .HasForeignKey("PossibleBuisnessId");

                    b.HasOne("ISOCertificate.Models.PossibleEnviroment", "PossibleEnviroment")
                        .WithMany("Investigates")
                        .HasForeignKey("PossibleEnviromentId");

                    b.HasOne("ISOCertificate.Models.PossiblePeople", "PossiblePeople")
                        .WithMany("Investigates")
                        .HasForeignKey("PossiblePeopleId");

                    b.HasOne("ISOCertificate.Models.PossibleProperty", "PossibleProperty")
                        .WithMany("Investigates")
                        .HasForeignKey("PossiblePropertyId");
            ...
            modelBuilder.Entity("ISOCertificate.Models.InvestigateLine", b =>
                {
                    ...
                    b.HasOne("ISOCertificate.Models.NominateLineType", null)
                        .WithMany("InvestigateLines")
                        .HasForeignKey("NominateLineTypeId");
                });
            ...
            modelBuilder.Entity("ISOCertificate.Models.NominateLine", b =>
                {
                    ...
                    b.HasOne("ISOCertificate.Models.NominateLineType", "TeamType")
                        .WithMany()
